...
#define KC_CONTROLLER PDF(_COLEMAK)
...
[_LOWER] = LAYOUT(
  ...
  KC_TRNS,  KC_F11, KC_F12,   KC_EQL,  KC_GRV,  LALT_T(KC_X),                       KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, KC_BSLS, KC_NO,
  KC_TRNS,  KC_EQL,  KC_MINS, KC_PLUS, KC_LCBR, KC_TAB, KC_TRNS,           KC_TRNS, KC_CAPS, KC_PLUS, KC_MINS, KC_EQL, KC_PIPE, KC_TRNS,
...
[_RAISE] = LAYOUT(
  ...
  KC_TRNS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                 KC_6,     KC_7,    KC_8,  KC_9,    KC_SCLN,   KC_NO,
  KC_TRNS, KC_ESC, KC_0,    KC_EQL,  KC_GRV,  LALT_T(KC_X),                          KC_LEFT,  KC_DOWN, KC_UP, KC_RGHT, KC_MINUS,  KC_NO,
  KC_TRNS, C(KC_Z), C(KC_X), C(KC_C), LSG(KC_4), KC_TAB,  KC_TRNS,           KC_TRNS,  KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS,   KC_BSLS, KC_NO,
                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
/*
 * ADJUST
