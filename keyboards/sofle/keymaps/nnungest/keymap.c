...
[_RAISE] = LAYOUT(
  ...
  KC_TRNS, KC_LALT,  KC_LCTL,  KC_LSFT,  KC_NO, KC_CAPS,                           KC_LEFT,  KC_DOWN, KC_UP, KC_RGHT,  KC_DASH, KC_BSPC,
  KC_TRNS, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_NO,  KC_TRNS,           KC_TRNS,  KC_NO, KC_LSTRT, KC_NO, KC_LEND,   KC_NO, KC_TRNS,
                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
